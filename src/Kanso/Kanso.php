...
class Kanso 
{
	...
	*******************************************************************************/
	...
	/**
	 * Parse and load application settings
	 *
	 * @return array
	 */
	...
	/**
	 * Refresh Kanso's cofiguration
	 *
	 * @param  array    $userSettings    Optional configuration settings
	 * @return array
	 */
	public function refreshConfig($userSettings = null) 
	{
		$this->Config = ($userSettings === null ? $this->parseSettings() : $userSettings );
		return $this->Config;
	}

	/**
	 * Set a key-value pair in Kanso's Config
	 *
	 * @see    \Kanso\Utility\Ini::encode
	 * @param  string    $key     The key to be changed
	 * @param  value     $value   The value to be set
	 */
	public function setConfigPair($key, $value)
	{
		...
		# Fire the event
		\Kanso\Events::fire('configChange', [$config]);
	}

	/**
	 * Set Kanso Config
	 *
	 * Reset Kanso's entire config to a specified value
	 *
	 * @see    \Kanso\Utility\Ini::encode
	...
	{
		# Merge the config with the current
