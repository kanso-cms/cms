...
class Email
{
    ...
    {
        $this->theme['logo_url'] = \Kanso\Kanso::getInstance()->Environment['KANSO_IMGS_URL'].'/kanso-logo-small.jpg';
    }
    ...
    public function preset($template, $vars)
    {
        ...
        return \Kanso\Kanso::getInstance()->FileSystem->ob_read($filePath, $variables);
    }
     ...
     * @return bool
    */
    public function send($toEmail, $senderName, $senderEmail, $subject, $content, $format = 'html') 
    {
        if ($format === 'html') {
     ...
     * @return string
    */
    public function html($subject, $content)
    {
        ...
        $variables = array_merge($this->theme, $variables);
        return \Kanso\Kanso::getInstance()->FileSystem->ob_read($body_path, $variables);
    }
     ...
     *
     * @access  public
     * @param   array   $theme  Assoc array of theme variables
     */
     ...
     * @return  string
     */
    public function button($href, $text, $size = 'md')
    {
