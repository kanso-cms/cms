		    ...
		    <div class="drop-menu drop-sw">
		        <div class="drop">
		            <ul>
		            	...
		            	<li><a href="/admin/comments/?<?php echo "&sort=$queries[sort]&search=$queries[search]&status=deleted"; ?>" <?php if ($queries['status'] === 'deleted') echo 'class="selected"';?>>Deleted</a></li>
		            </ul>
		        </div>
		    </div>
		</div>
