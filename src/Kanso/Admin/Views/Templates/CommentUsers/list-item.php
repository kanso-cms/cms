<?php 
	$userSlug  = \Kanso\Utility\Str::slugFilter($commenter['email']);
	$rep_text  = 'Average';
	$rep_color = 'info';
		...
		<div class="media-body gutter-md">
			<div class="floor-xs">
				<span class="avatar inline-block v-middle">
					<img src="<?php echo $commenter['avatar']; ?>" width="32" height="32">
				</span>
	        ...
	        <div class="color-gray">
	        	...
	        	<span class="p6 color-gray-light">&nbsp;&nbsp;•&nbsp;&nbsp;</span>
	        	with <?php echo $commenter['posted_count']; ?> <?php echo \Kanso\Utility\Pluralize::convert('comment', $commenter['posted_count']);?>
	        	<span class="p6 color-gray-light">&nbsp;&nbsp;•&nbsp;&nbsp;</span>
