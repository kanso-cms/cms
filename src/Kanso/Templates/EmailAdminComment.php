...
/**
 * Kanso email content for notifying admins of a new comment
 *
 */
echo '
    <p style="font-size: 17px;margin:0;color: #5a6166;font-weight: 300;line-height: 31px;">
        Hi '.$data['admin']['name'].',<br>
    ...
    <p style="font-size: 13px;margin:0;color: #939ca2;font-weight: 300;line-height: 19px;">
        You\'re receiving this message because you\'re an administrator at '.$data['website'].' and are signed up to receive comment notifications.<br>
        You can unsubscribe from comment notifications by logging in to your admin panel and changing your notification settings.
    </p>
