...
(function() {
    ...
    ** Global variables for application
    ...
    // Context menu vars
    var contextMenu  = $('.js-context-menu');
    var cutTrigger   = $('.js-cut');
    var copyTrigger  = $('.js-copy');
    var pasteTrigger = $('.js-paste');
    var titleCaseTrg = $('.js-titlecase');
    var lowerCaseTrg = $('.js-lowercase');
    var upperCaseTrg = $('.js-uppercase');
...
KansoWriter.prototype.saveArticle = function(e, self) {
    ...
    Ajax.post(ajaxURL, validator.form(), function(success) {
        ...
        if (responseObj && responseObj.response) {
            self.articleID = responseObj['response']['id'];
...
KansoWriter.prototype.publishArticle = function(e, self) {
    ...
    Ajax.post(ajaxURL, validator.form(), function(success) {
        ...
        if (responseObj && responseObj.response) {
            self.articleID = responseObj['response']['id'];
            self.ajaxType  = 'writer_save_existing_article';
            var slug       = location.protocol + "//" + location.host + '/' + responseObj['response']['slug'];
