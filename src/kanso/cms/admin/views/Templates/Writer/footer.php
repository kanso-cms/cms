<div class="writer-footer js-writer-footer">
	<div>
		<!-- TOGGLES -->
		...
		<div class="col col-10 writer-powers">
			...
			<button class="js-show-media-lib tooltipped tooltipped-n" data-tooltip="Media library"><svg viewBox="0 0 500 500"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#picture"></use></svg></button>
		</div>
	</div>
</div>