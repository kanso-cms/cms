...
class MiddlewareTest
{
	...
	public function testNonStaticClassMethod()
	{
		...
		$layer = new Middleware('\tests\unit\onion\MiddleWareCallbackTest@normalMethod', ['foo', 'bar']);
	...
	public function testStaticClassMethod()
	{
		...
		$layer = new Middleware('\tests\unit\onion\MiddleWareCallbackTest::staticFunc', ['foo', 'bar']);
	...
	public function testGetCallback()
	{
		...
		$this->assertEquals('\tests\unit\onion\MiddleWareCallbackTest::staticFunc', $layer->getCallback());
	}
	...
	public function testGetArgs()
	{
		...
		$layer = new Middleware('\tests\unit\onion\MiddleWareCallbackTest::staticFunc', 'foo');
