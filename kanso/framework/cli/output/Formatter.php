...
class Formatter
{
	...
	protected function getStyleCodes(string $tag): array
	{
		...
		throw new Exception(vsprintf('Undefined formatting tag [ %s ] detected.', [$tag]));
	}
	...
	protected function closeStyle(string $tag): string
	{
		...
		{
			throw new Exception('Detected incorrectly nested formatting tag.');
		}
	...
	public function format(string $string): string
	{
		...
		if(!empty($this->openTags))
		{
			throw new Exception('Detected missing formatting close tag.');
		}
