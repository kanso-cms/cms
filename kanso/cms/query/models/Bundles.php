...
/**
 * Filter bundles page as category.
 *
 * @author Joe J. Howard
 */
class Bundles extends FilterBase implements FilterInterface
{
    /**
     * The request type.
     *
    ...
    public function filter(): bool
    {
        ...
        $this->Query->queryStr     = 'post_status = published : post_type = bundle : orderBy = post_created, DESC';
